...
<html lang="en">
  <head>
    ...
    <title>I-MiNOR - Video Tutorial</title>
  ...
  <body>
	...
	<!--div class="demo-panel">
		...
		<ul class="stylechanger tooltips">
			...
			<li><a id="color2" href="singlepost-leftsidebar.html#" data-skin="pink.css"></a></li>				
			<li><a id="color3" href="singlepost-leftsidebar.html#" data-skin="navy.css"></a></li>
			<li><a id="color4" href="singlepost-leftsidebar.html#" data-skin="blue.css"></a></li>	
			<li><a id="color5" href="singlepost-leftsidebar.html#" data-skin="orange.css"></a></li>
			<li><a id="color6" href="singlepost-leftsidebar.html#" data-skin="purple.css"></a></li>
			<li><a id="color7" href="singlepost-leftsidebar.html#" data-skin="violet.css"></a></li>
			<li><a id="color8" href="singlepost-leftsidebar.html#" data-skin="green.css"></a></li>			
			<li><a id="color9" href="singlepost-leftsidebar.html#" data-skin="misty.css"></a></li>
			<li><a id="color10" href="singlepost-leftsidebar.html#" data-skin="yellow.css"></a></li>				
		</ul>
	...
	<a class="openpanel" href="singlepost-leftsidebar.html#" title=""><i class="icon-equalizer2"></i></a>
	<!-- End demo options --> 
						...
						<aside>
							...
							<!--div class="widget">
								...
								<ul class="tags">
									...
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> Design</a></li>
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> Photo</a></li>
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> Graphic</a></li>
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> logo</a></li>
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> Icon</a></li>
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> Tips</a></li>
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> Tutorial</a></li>
									<li><a href="singlepost-leftsidebar.html#"><i class="icon-pricetags"></i> Resource</a></li>
					...
					<div class="col-md-9 col-sm-9">
						<!-- Start article 1 -->
							<div class="article-post">
								<div class="post-date"><span>12</span>Sept</div>
										<h5><a href="#">Maaf Belum Tersedia</a></h5>
								
									
								<div class="video-container article-media">
									<iframe id="player" src="https://www.youtube.com/embed/https://youtu.be/Hl-zzrqQoSE?list=PLFE2CE09D83EE3E28" class="img-thumbnail"></iframe>
								</div-->
								<article>
						...
						<div class="article-post">
							<div class="post-date"><span>12</span>Sept</div>
								...
								<div class="video-container article-media">
									<iframe id="player" src="https://www.youtube.com/embed/https://youtu.be/d6IIZ6oREcE?list=PLCZlgfAG0GXDUvrO3Bc_VUvIjWKnYIRJ1" class="img-thumbnail"></iframe>
								</div-->
								<article>
									<div class="article-title">
						...
						<div class="article-post">
							<div class="post-date"><span>12</span>Sept</div>
								...
								<div class="video-container article-media">
									<iframe id="player" src="https://www.youtube.com/embed/https://youtu.be/dineyA-1Px0" class="img-thumbnail"></iframe>
								</div-->
								<article>
									<div class="article-title">
						...
						<h5 class="head-title">Comments (5)</h5>
						<div class="media">
							<div class="media-left">
								<a href="singlepost-leftsidebar.html#">
									<img class="media-object" src="img/blog/avatar/author01.jpg" alt="" />
								</a>
							</div>
							<div class="media-body">
								<h6 class="media-heading"><a href="singlepost-leftsidebar.html#">Janny doe</a></h6>
								<p>
								...
								<p class="reply"><a href="singlepost-leftsidebar.html#"><i class="icon-link"></i> Reply</a></p>
							</div>
						</div>
						...
						<div class="media">
							...
							<div class="media-body">
								<h6 class="media-heading"><a href="singlepost-leftsidebar.html#">John doe</a></h6>
								<p>
								...
								<div class="media">
									...
									<div class="media-body">
										<h6 class="media-heading"><a href="singlepost-leftsidebar.html#">Jenny doe</a></h6>
										<p>
