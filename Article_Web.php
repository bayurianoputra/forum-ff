...
<html lang="en">
  <head>
    ...
    <title>I-MiNOR - Article- Web</title>
  ...
  <body>
	...
	<!--div class="demo-panel">
		...
		<ul class="stylechanger tooltips">
			...
			<li><a id="color2" href="blog-alt2-leftsidebar.html#" data-skin="pink.css"></a></li>				
			<li><a id="color3" href="blog-alt2-leftsidebar.html#" data-skin="navy.css"></a></li>
			<li><a id="color4" href="blog-alt2-leftsidebar.html#" data-skin="blue.css"></a></li>	
			<li><a id="color5" href="blog-alt2-leftsidebar.html#" data-skin="orange.css"></a></li>
			<li><a id="color6" href="blog-alt2-leftsidebar.html#" data-skin="purple.css"></a></li>
			<li><a id="color7" href="blog-alt2-leftsidebar.html#" data-skin="violet.css"></a></li>
			<li><a id="color8" href="blog-alt2-leftsidebar.html#" data-skin="green.css"></a></li>			
			<li><a id="color9" href="blog-alt2-leftsidebar.html#" data-skin="misty.css"></a></li>
			<li><a id="color10" href="blog-alt2-leftsidebar.html#" data-skin="yellow.css"></a></li>				
		</ul>
	...
	<a class="openpanel" href="blog-alt2-leftsidebar.html#" title=""><i class="icon-equalizer2"></i></a>
	<!-- End demo options --> 
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<h3><i class="icon-book-open"></i> Web </h3>
						</div>
						...
						<aside>
							...
							<!--div class="widget">
								...
								<ul class="tags">
									...
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> Design</a></li>
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> Photo</a></li>
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> Graphic</a></li>
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> logo</a></li>
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> Icon</a></li>
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> Tips</a></li>
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> Tutorial</a></li>
									<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pricetags"></i> Resource</a></li>
						...
						<!-- Start article 1 -->
							<div class="article-post">
								...
								<article>
									...
									<p>
									Modul ini dibuat untuk menjadi panduan dalam membuat sebuat aplikasi web dengan
...
oleh user/admin dengan username dan password yang tersimpan didatabase.
							...
							<div class="article-post">
								<article>
									<div class="article-title">
										...
										<h5><a href="blog-alt2-leftsidebar.html#">Iusto veritus an eos, eam ad graece</a></h5>
										<ul class="mata-post">
											<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-profile-male"></i> John doe</a></li>
											<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pencil"></i> Photography</a></li>
											<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-chat"></i> 3 comments</a></li>
										</ul>
									</div>
									<p>
							...
							<!--div class="article-post">
								...
								<article>
									<div class="article-title">
										...
										<h5><a href="blog-alt2-leftsidebar.html#">Numquam detraxit sit ei an vel</a></h5>
										<ul class="mata-post">
											<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-profile-male"></i> John doe</a></li>
											<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-pencil"></i> Photography</a></li>
											<li><a href="blog-alt2-leftsidebar.html#"><i class="icon-chat"></i> 3 comments</a></li>
						...
						<ul class="pagination margin-clear">
							...
							<li class="active"><a href="blog-alt2-leftsidebar.html#">1</a></li>
							<li><a href="blog-alt2-leftsidebar.html#">2</a></li>
							<li><a href="blog-alt2-leftsidebar.html#">3</a></li>
